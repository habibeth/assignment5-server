...
route.get('/', slots_controller_1.SlotsControllers.getAllSlots);
route.patch('/:id', (0, auth_1.default)(user_constant_1.USER_ROLE.admin), slots_controller_1.SlotsControllers.updateSlots);
route.delete('/:id', (0, auth_1.default)(user_constant_1.USER_ROLE.admin), slots_controller_1.SlotsControllers.deleteSlots);
