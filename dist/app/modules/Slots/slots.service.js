...
const getAllSlotsFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const meta = yield SlotsQuery.countTotal();
    return {
        meta,
        result
    };
});
const updateSlotsIntoDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield slots_model_1.Slots.findByIdAndUpdate(id, {
        isDeleted: false
    }, {
        new: true
    });
...
const deleteSlotsIntoDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield slots_model_1.Slots.findOneAndUpdate({
        _id: id
    }, {
        isDeleted: true,
    }, {
