...
route.patch('/:roomId', (0, auth_1.default)(user_constant_1.USER_ROLE.admin), (0, vaildRequest_1.default)(room_validation_1.RoomValidationSchema.updateRoomValidationSchema), room_controller_1.RoomControllers.updateRoom);
